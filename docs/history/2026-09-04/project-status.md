...
- After v5.0.15, the ranked code work is: the BND-NEXT-45 install-path replacement train (45A–45C as 5.0.16 enablers, 45D–45F as the 5.1.0 install-contract change; retires the BND-NEXT-41 helper-orchestration proof, absorbs BND-NEXT-28 and BND-NEXT-29 items 3/5); then BND-NEXT-27; BND-NEXT-20E; BND-NEXT-21 (implementation as 45G); BND-NEXT-33B/33C with BND-NEXT-33A design in parallel; complete BND-NEXT-34 then BND-NEXT-43. BND-NEXT-32 remains analysis-first and should run after 45F shrinks the surface it would inventory; BND-NEXT-22, BND-NEXT-36, and BND-NEXT-30 stay later.
