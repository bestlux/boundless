...
## [3.0.0](https://github.com/bestlux/boundless/compare/v2.1.0...v3.0.0) (2026-03-19)
...
* add approval-based nearby pairing flow ([d3b53d7](https://github.com/bestlux/boundless/commit/d3b53d796706ecf14ffdfa20d5c5bee4655988f3))
* add clipboard image sync runtime and transport hooks ([a145c69](https://github.com/bestlux/boundless/commit/a145c6978f9b4403973313c74361e8588b2137c3))
* add diagnostics hotkey action triggers ([e58af1f](https://github.com/bestlux/boundless/commit/e58af1f804b5875b3df8552ceae587adf77f7e98))
* add input capture target runtime and windows capture polling ([ce73645](https://github.com/bestlux/boundless/commit/ce73645efbbd20146811a68731ddfb69ff5d4708))
* add input latency telemetry and report tooling ([a8551ac](https://github.com/bestlux/boundless/commit/a8551ac91fe0c2861d686f08407e53adfc23f1e2))
* add input ownership control plane and routing primitives ([ead799d](https://github.com/bestlux/boundless/commit/ead799d442e7043ab039de00c4371661d013ed81))
* add input runtime queue and synthetic key helper ([009c0ff](https://github.com/bestlux/boundless/commit/009c0ff5c5db5b86b926d2d555a9e1bd6194a9f7))
* add interactive console flow for runtime control ([8b5ba51](https://github.com/bestlux/boundless/commit/8b5ba51564f90d1ab1ddbd3e05ea6a899516968b))
* add layout-driven edge capture handoff ([39bd8cb](https://github.com/bestlux/boundless/commit/39bd8cb6e0c05b75913d7ae47b957ac3f262eab7))
* add mDNS discovery runtime with manual fallback ([4ed3d8b](https://github.com/bestlux/boundless/commit/4ed3d8b62db47bf77151f99daa05060408d4b018))
* add payload transfer commands and transport diagnostics ([c32f09e](https://github.com/bestlux/boundless/commit/c32f09ef945edd633f90b4b8cbaf72918151d8fd))
* add runtime clipboard text sync pipeline ([b1b57d1](https://github.com/bestlux/boundless/commit/b1b57d118c7b6069c24ff19f5a1bc357194cefbb))
* add tls peer transport, trust bundles, and two-node smoke harness ([abc44ab](https://github.com/bestlux/boundless/commit/abc44ab894be4288193d16cfbf9469353a1f83d2))
* add windows hotkey runtime actions ([57f99f9](https://github.com/bestlux/boundless/commit/57f99f90780ef4d3a3cda77e8892c45c8f4e6b75))
* add windows low-level hook capture backend ([6aedaca](https://github.com/bestlux/boundless/commit/6aedaca0508d8e52d829c491ca00e64b4dc1dc13))
* add windows named-pipe control plane transport ([0eae925](https://github.com/bestlux/boundless/commit/0eae9253d9fcf50c32be71a32dc0d94c126c1a61))
* bootstrap boundless workspace with daemon, cli, and CI/release automation ([15f551b](https://github.com/bestlux/boundless/commit/15f551bdc516d5680a151776b2195fb808ba1294))
* **daemon:** add strict input lock and topology handoff runtime ([05dde78](https://github.com/bestlux/boundless/commit/05dde789804e6ea4333ddc9e7e279d35f40f3b97))
...
* **dev:** add edge handoff trace capture helper ([ba1b387](https://github.com/bestlux/boundless/commit/ba1b387e0b6baf3ba348da092642822beb69655d))
* **dev:** add unified test suite runner profiles ([2772a57](https://github.com/bestlux/boundless/commit/2772a57d10f68662167567e5f4d303aa03f86fa5))
...
* implement switch-all hotkey capture rotation ([704970c](https://github.com/bestlux/boundless/commit/704970ccf26e427918954f6759cc3dd5e9003a4e))
* implement windows sendinput input injection backend ([5b28995](https://github.com/bestlux/boundless/commit/5b28995c9966c2fa46f6141fcebdae39ef2ef498))
* **input:** add raw-input mouse capture with hook fallback ([d023599](https://github.com/bestlux/boundless/commit/d023599002bf2ef2040387d78001679c05b0b827))
* **input:** auto-start control on local edge handoff ([4d85022](https://github.com/bestlux/boundless/commit/4d85022839f705a9c38c1a9badc58ac31797f019))
* **input:** harden injection runtime and ownership gating ([9cdcf67](https://github.com/bestlux/boundless/commit/9cdcf671defae3ad9a350ff31e3613d899b5baea))
* **network:** harden framing, flushing, and inbound file handling ([6f8d24b](https://github.com/bestlux/boundless/commit/6f8d24b71fecd024056f2d28d4848d0894eab28f))
...
* route input frames over transport with noop sink ([960fcc9](https://github.com/bestlux/boundless/commit/960fcc9a368a1a9cdc9cd0b40a86f9593e7471fa))
...
* simplify console pairing with discovered peer requests ([5417ed4](https://github.com/bestlux/boundless/commit/5417ed4c5cb21865a22fc06a990dae57547fde08))
...
* accept hostname bundle addresses and harden pairing port fallback ([55f077c](https://github.com/bestlux/boundless/commit/55f077ca67baacc3ebdfc9f4330e63ef31f272e1))
* auto-fallback transport bind port on startup ([29fc2c7](https://github.com/bestlux/boundless/commit/29fc2c7a4680d9bd90efbf06e44da1acdb62de3c))
* avoid input replay after partial sendinput success ([cb0dac0](https://github.com/bestlux/boundless/commit/cb0dac01a3feb0ce119aaf93ec8075746885935c))
* avoid non-windows pipe-path unused warning ([9db84af](https://github.com/bestlux/boundless/commit/9db84afebce64eb1e58896efedc735ca842bcbd2))
...
* clear peer input sequence state on disconnect ([f41ecd9](https://github.com/bestlux/boundless/commit/f41ecd921dad943ea79131360ad9e15f6d88eb6b))
* clear stale input owner when removing peer ([c3c5dcd](https://github.com/bestlux/boundless/commit/c3c5dcd87769d9008443bdf76bd711cdc62c078b))
...
* **daemon:** forward held-key repeats during remote control ([68f484f](https://github.com/bestlux/boundless/commit/68f484ff902755cac855a045977fe2f0a06c7a21))
* **daemon:** gate hotkey warn import for non-windows builds ([9fbf33a](https://github.com/bestlux/boundless/commit/9fbf33a273631f1077c9f4ad4241f7f2a4ccb30d))
* **daemon:** gate windows-only hotkey/input items ([3b31ccb](https://github.com/bestlux/boundless/commit/3b31ccb9a52b35cbb1aa63d1dc5729d10689b8ff))
* **daemon:** make edge handoff work with single-peer legacy layouts ([ee42074](https://github.com/bestlux/boundless/commit/ee42074b3eed1da63709bf462f5f700d3b5d5344))
* **daemon:** reduce edge handoff bounce and anchor drift ([52e0904](https://github.com/bestlux/boundless/commit/52e0904462a92aa5c187c4efdea9130fcbff0761))
...
* **daemon:** resolve cross-platform clippy warnings ([5d589b2](https://github.com/bestlux/boundless/commit/5d589b292879e8013e53adf496f313c97598eacf))
...
* default config_version for legacy config parsing ([964916e](https://github.com/bestlux/boundless/commit/964916e96b79920b321a2bdcdcf1881c6a8c1ea9))
* **dev:** avoid stale last exit code in test suite runner ([6cc0517](https://github.com/bestlux/boundless/commit/6cc0517e59e13e5717c4410629be8f5e6a3d1e78))
* drain capture hook events while target is inactive ([80bfb2b](https://github.com/bestlux/boundless/commit/80bfb2b69072583cec142e8f9a4cc9de3e9ab976))
* enforce pairing code validation and bind precheck ([738e275](https://github.com/bestlux/boundless/commit/738e275b9b3b1d9e6ac54e769a310f964aa14241))
* fail smoke scripts when cargo build exits non-zero ([3df188d](https://github.com/bestlux/boundless/commit/3df188d23acd5796cb2dfc0d859f4a9084145979))
* flush input release events on capture target transition ([064153f](https://github.com/bestlux/boundless/commit/064153fdd7ba376b1ed0039cf6c9679d6d743a72))
* force reconnect hotkey to tear down active sessions ([9602712](https://github.com/bestlux/boundless/commit/960271236501f2323568a9f9270aa4758a689375))
* gate image frames by protocol and validate bmp payloads ([97135a5](https://github.com/bestlux/boundless/commit/97135a5ca0b43d07e9401e620eb2eb7ce3045f31))
* gate windows-only input runtime symbols ([f599b74](https://github.com/bestlux/boundless/commit/f599b74792acbe5f07683bde8c4d0cf92b62d41c))
* hard-abort reconnect sessions and preserve hotkey edges ([bcfa916](https://github.com/bestlux/boundless/commit/bcfa9165b6191032e0a9a11f513a21d5d079c79f))
* harden peer identity and trust import handling ([c97781f](https://github.com/bestlux/boundless/commit/c97781f614789badd547b1b7121651c8d5b31f8d))
...
* **input:** anchor cursor position on edge handoff ([09e17bd](https://github.com/bestlux/boundless/commit/09e17bde333d16aae2741842caf6945b9ff688c7))
* **input:** gate auto handoff on real screen edges ([e745403](https://github.com/bestlux/boundless/commit/e745403e2e135b66120a895233f153e01056e0e1))
* **input:** preserve move ordering and ignore absolute raw packets ([9ca4422](https://github.com/bestlux/boundless/commit/9ca4422ae8f0a946184bd00e419a323b32692fb6))
* **input:** restore local edge handoff in raw mode ([dc63ed1](https://github.com/bestlux/boundless/commit/dc63ed1475dbddfb83e710ac32ed5538b1d3ca81))
* **input:** stabilize handoff routing and escape unlock ([a664f32](https://github.com/bestlux/boundless/commit/a664f32415c518fc7d9f63cf9626142b06b1f0e9))
* **input:** suppress mouse move while lock is active ([a394f6b](https://github.com/bestlux/boundless/commit/a394f6b49b01db21589736089e840c2ba2646ac9))
* **input:** trigger local handoff on edge push ([2754665](https://github.com/bestlux/boundless/commit/27546657aa26a96f7f54ca21a265c3661c3c0a5d))
...
* preserve mdns ipv6 scope and avoid partial trust imports ([4b6ddb6](https://github.com/bestlux/boundless/commit/4b6ddb611457b85caefaf721e3d57870c0980046))
* prevent stale clipboard dedupe while disconnected ([53a2608](https://github.com/bestlux/boundless/commit/53a2608af1ee67f43e584c76e480893d50765e75))
* refactor input timing telemetry helpers for clippy ([e63fb7e](https://github.com/bestlux/boundless/commit/e63fb7e737d66b8e02a32135b4e8a99da47a26e7))
...
* require active capture for edge handoff ([204744e](https://github.com/bestlux/boundless/commit/204744e4c1cc2e8c9036c0c919a995700eca66f8))
* restore console control with inbound owner auto-claim ([6f98d3d](https://github.com/bestlux/boundless/commit/6f98d3debabeee51d703746e519ebd094f7facca))
...
* retain unsent payloads and sanitize inbound file names ([5c967cb](https://github.com/bestlux/boundless/commit/5c967cbaaa953d4bca6e17f476f2a0ac5a2ae2f3))
* retry busy named-pipe connects and report effective transport ([2113600](https://github.com/bestlux/boundless/commit/2113600990e345095cf0ed22c43ee727a4162253))
...
* revalidate input ownership before queued inject ([58ce402](https://github.com/bestlux/boundless/commit/58ce4025e76211c1391f5330bd482221c4b566c1))
* scope smoke incremental override to guarded block ([e8ee8da](https://github.com/bestlux/boundless/commit/e8ee8da46595f1506a76980de6eff86be5e5daa8))
...
* improve performance + tray UI ([#3](https://github.com/bestlux/boundless/issues/3)) ([1f6e3ab](https://github.com/bestlux/boundless/commit/1f6e3abf792eae1582d111234fc6c5d3e4189dbc))
* reduce input latency with fast outbound flush tick ([d1a118d](https://github.com/bestlux/boundless/commit/d1a118d605f2aa7d1833a2853da5a5551d086991))
